...
straightforward way to obtain micro-environmental statistics and
epidemiological indicators (e.g., bare soil, stagnation, synthetic
materials) from UAV orthomosaics. Designed to map localized infection
risks, such as *Fasciola hepatica* and vector-borne diseases, within a
...
`drones4health` implements standardized spectral indices alongside novel
epidemiological indicators optimized for drone imagery.
...
This example demonstrates how to calculate the Vulnerability Stagnation
Indicator (IEV) and map *Fasciola hepatica* environmental suitability
using multi-spectral and thermal drone surveys.
